...
start:env_file
	...
	${INFO} "Adding *.art.andela.com domains to your host file"
	@ chmod +x scripts/utils.sh && scripts/utils.sh addHost api.art.andela.com
	@ chmod +x scripts/utils.sh && scripts/utils.sh addHost database.art.andela.com
	@ echo "  "
	@ ${INFO} "Building required docker images"
	@ docker-compose -f $(DOCKER_DEV_COMPOSE_FILE) build nginx
